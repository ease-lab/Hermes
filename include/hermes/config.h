...
-----------------PCIe BATCHING---------------------
--------------------------------------------------*/
#define MAX_PCIE_BCAST_BATCH 3 //6 //3 ///4 //8 //(128 / (MACHINE_NUM - 1)) // how many broadcasts can fit in a batch
...
-----------------FLOW CONTROL---------------------
--------------------------------------------------*/
#define CREDITS_PER_REMOTE_WORKER MAX_BATCH_OPS_SIZE //3 //60 //30
