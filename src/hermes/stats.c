...
void *print_stats(void* no_arg){
    ...
    while(true) {
        ...
        for (i = 0; i < WORKERS_PER_MACHINE; i++) {
            all_clients_cache_hits += curr_w_stats[i].cache_hits_per_worker - prev_w_stats[i].cache_hits_per_worker;
            ...
            all_stats.updates_per_worker[i] = (curr_w_stats[i].vals_per_worker - prev_w_stats[i].vals_per_worker) / seconds;
            all_stats.invs_per_worker[i] = (curr_w_stats[i].invs_per_worker - prev_w_stats[i].invs_per_worker) / seconds;
            all_stats.acks_per_worker[i] = (curr_w_stats[i].acks_per_worker - prev_w_stats[i].acks_per_worker) / seconds;
