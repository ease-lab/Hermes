...
// ------COMMON-------------------
#define MAX_BCAST_BATCH 1 ///4 //8 //(128 / (MACHINE_NUM - 1)) // how many broadcasts can fit in a batch
#define MAX_MESSAGES_IN_BCAST (MACHINE_NUM - 1)
#define MESSAGES_IN_BCAST_BATCH MAX_BCAST_BATCH * MAX_MESSAGES_IN_BCAST //must be smaller than the q_depth
...
//#define SEND_INV_Q_DEPTH (RECV_INV_Q_DEPTH) //((MACHINE_NUM - 1) * INV_CREDITS )
//#define SEND_ACK_Q_DEPTH (RECV_ACK_Q_DEPTH)
//#define SEND_VAL_Q_DEPTH (RECV_VAL_Q_DEPTH)
//#define SEND_CRD_Q_DEPTH (RECV_CRD_Q_DEPTH)

#define SEND_INV_Q_DEPTH ((MACHINE_NUM - 1) * INV_CREDITS)
#define SEND_ACK_Q_DEPTH ((MACHINE_NUM - 1) * ACK_CREDITS)
#define SEND_VAL_Q_DEPTH ((MACHINE_NUM - 1) * VAL_CREDITS)
...
#define BROADCAST_SS_BATCH MIN_SS_BATCH
#define ACK_SS_BATCH  MIN_SS_BATCH
