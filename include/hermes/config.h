...
#define MAX_LATENCY 2000 //in us
#define LATENCY_BUCKETS 2000
...
#define CREDITS_PER_REMOTE_WORKER 25 //(MAX_BATCH_OPS_SIZE) // CR
...
#define PRINT_NUM_STATS_BEFORE_EXITING 3 //80
