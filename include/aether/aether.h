...
void aether_ud_channel_crd_init(struct hrd_ctrl_blk *cb, ud_channel_t *ud_c,
                                uint8_t qp_id, char* qp_name, qp_info_t *remote_qps,
                                volatile uint8_t *incoming_reqs_ptr,
                                // credits
                                ud_channel_t *linked_channel, uint8_t credits_per_rem_channel, uint16_t num_channels,
                                //Toggles
                                uint8_t enable_stats, uint8_t enable_prints);
